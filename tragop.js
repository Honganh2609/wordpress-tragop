...
(function($){
    ...
    $(document).ready(function () {
        ...
        <a rel="nofollow" class="devvn_vimo_button" href="/flatsome/tra-gop/?pro=`+ proid +`&type=bank"><span>MUA TRẢ GÓP 0%</span><small>Duyệt hồ sơ tại cửa hàng</small></a>
        <a rel="nofollow" class="devvn_vimo_button" href="/flatsome/tra-gop/?pro=`+ proid +`&type=vimo"><span>TRẢ GÓP QUA THẺ</span><small>Visa, Master, JCB</small></a>
        </div>`;
        $('.cart').append(string);
